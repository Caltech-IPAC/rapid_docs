...
- Every applied migration is recorded in the database itself:
  identifier, checksum, application time. The live schema version
...
running system does at the time, not only about what it should do, and
...
hours. One interaction is recorded rather than assumed: a WAL availability valve
